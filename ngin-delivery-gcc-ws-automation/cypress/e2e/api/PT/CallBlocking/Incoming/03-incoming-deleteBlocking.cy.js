const endPoint = "gcc-external-services/blocking/incoming/delete";
const SubscriberCB = "351912345697";
const PhoneNumber = "35191111";

describe("INCOMING Barring - deleteBlocking",{env: {hideCredentials: true }}, () => {
  ...
  it.skip("Delete Allow Number Already Deleted", () => {
    const subscribers = {
      ws: endPoint,
      subscriber: SubscriberCB,
      numberRange: "N",
